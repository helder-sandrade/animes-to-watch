...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-ii=0o2$g82tims85etzk18b99q#(w3297y8be$=ri&cp^62fj$')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DBNAME', 'animes-to-watch'),
        'USER': os.getenv('DBUSER', 'helder'),
        'PASSWORD': os.getenv('DBPASS', 'helder'),
...
# configuring the logging module to write to the database and display it on the console
